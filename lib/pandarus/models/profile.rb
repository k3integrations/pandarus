...
module Pandarus
  class Profile < ModelBase
    attr_accessor :id, :name, :short_name, :sortable_name, :title, :bio, :primary_email, :login_id, :sis_user_id, :sis_login_id, :avatar_url, :integration_id, :calendar, :time_zone
    ...
    def self.attribute_map
      {
        ...
        integration_id: { external: 'integration_id', container: false, type: 'Integer' },
